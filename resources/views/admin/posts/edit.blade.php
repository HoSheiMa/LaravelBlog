        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.posts.update', $post->id) }}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')    
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ $post->title }}" id="postTitle" aria-describedby="postTitle">
                                </div>
                                <div class="form-group">
                                    <label for="postMetaTitle">Post Meta Title</label>
                                    <input type="text" class="form-control" name="meta_title" value="{{ $post->meta_title }}" id="postMetaTitle" aria-describedby="postMetaTitle">
                                </div>
                                <div class="form-group">
                                    <label for="postMetaDescription">Post Meta Description</label>
                                    <input type="text" class="form-control" name="meta_description" value="{{ $post->meta_description }}" id="postMetaDescription" aria-describedby="postMetaDescription">
                                </div>
                                <div class="form-group mt-5">
                                    <label for="postEditor">Post Content</label>
                                    <textarea class="form-control" name="body" id="postEditor" rows="10">{{ $post->body }}</textarea>
                                </div>
                            </div>
