...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group row">               
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="meta_title" id="name" class="form-control mb-4">
                                </div>  
                            </div>
                            ...
                            <div class="form-group row">               
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="meta_description" id="name" class="form-control mb-4">
                                </div>  
                            </div>
